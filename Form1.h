...
private: bool update()
		 {
			 return c->send(hScrollBar1->Value,hScrollBar2->Value,hScrollBar3->Value,hScrollBar4->Value,
				 ...
				 hScrollBar10->Value,hScrollBar11->Value,hScrollBar12->Value,hScrollBar13->Value,hScrollBar14->Value,
				 hScrollBar15->Value,hScrollBar16->Value,hScrollBar17->Value,hScrollBar18->Value,hScrollBar19->Value,
				 hScrollBar20->Value,hScrollBar21->Value,hScrollBar22->Value,hScrollBar23->Value,hScrollBar24->Value,
				 hScrollBar25->Value);
		 }
